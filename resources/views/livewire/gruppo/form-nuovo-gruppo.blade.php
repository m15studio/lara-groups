<div>
    ...
    <x-jet-modal wire:model="nuovoGruppo" maxWidth="md">
        <x-slot name="content" id="creaGruppoContent">
            <form wire:submit.prevent="creaGruppo" id="form_nuovo_gruppo" name="form_nuovo_gruppo">
                        ...
                        <fieldset>
                            <div class=" border-b border-gray-200 divide-y divide-gray-200">
                                <div class="sm:col-span-3">
                                    ...
                                    <div class="mt-1">
                                        <input type="text" name="gruppo_nome" id="gruppo_nome" wire:model="gruppo_nome"
                ...
                <div class="mt-5 sm:mt-12 sm:flex sm:flex-row-reverse">
                    <x-jet-button class="ml-2 button button  text-white bg-bwt-pink hover:bg-bwt-pink-hover focus:ring-purple-500" form="form_nuovo_gruppo">
                        Aggiorna
                    </x-jet-button>
                    <x-jet-secondary-button wire:click="$toggle('nuovoGruppo')" wire:loading.attr="disabled" class="button border-gray-200  text-gray-700 bg-white hover:bg-gray-50 focus:ring-purple-500">
                        Cancella
